 ...
 *    
 *    Examples:
 *    - MonthlyInterestWorkflow.java
 *    - FundTransferWorkflow.java
 *
 * 2. CONCRETE MEDIATOR
 ...
 *    
 *    Examples:
 *    - MonthlyInterestWorkflowCoordinator.java
 *    - FundTransferWorkflowCoordinator.java
 *
 ...
 *    - MonthlyInterestAccounts.java
 *    - MonthlyInterestCalculator.java
 *    - InterestTransactionBuilder.java
 *    - InterestBalanceUpdater.java
 *    - InterestPostingAuditLogger.java
 *    - InterestNotificationSender.java
 *    
 *    Examples for Fund Transfer:
 *    - SourceAccountValidator.java
 *    - DestinationAccountValidator.java
 *    - TransferAccountStatusChecker.java
 *    - TransferOverdraftPolicy.java
 *    - TransferTransactionRecorder.java
 *    - TransferBalanceValidator.java
 *
 ...
 *    
 *    Examples for Monthly Interest:
 *    - DatabaseMonthlyInterestAccounts.java
 *    - AccountTypeMonthlyInterestCalculator.java
 *    - InterestPostingTransactionBuilder.java
 *    - AccountInterestBalanceUpdater.java
 *    - ConsoleInterestPostingAuditLogger.java
 *    - ConsoleInterestNotificationSender.java
 *    
 *    Examples for Fund Transfer:
 *    - SourceAccountAvailabilityValidator.java
 *    - DestinationAccountAvailabilityValidator.java
 *    - ActiveTransferAccountStatusChecker.java
 *    - AccountLimitOverdraftPolicy.java
 *    - DatabaseTransferTransactionRecorder.java
 *    - AvailableFundsTransferValidator.java
 *
 *
 ...
 * - InterestCalculator directly calls TransactionRecordBuilder
 * - TransactionRecordBuilder directly calls AccountUpdater
 ...
 *    - Example: MonthlyInterestAccounts only manages account data retrieval
 *             MonthlyInterestCalculator only calculates interest
 *
 ...
 *    - Example: Can swap DatabaseMonthlyInterestAccounts with DatabaseAccountPeer seamlessly
 *
 * 4. INTERFACE SEGREGATION
 *    - Each peer interface is focused and minimal
 *    - Clients depend only on methods they use
 *    - Example: SourceAccountValidator only has source-related methods
 *             DestinationAccountValidator only has destination methods
 *
 ...
 *    - Example: Mediator receives MonthlyInterestAccounts interface, not DatabaseMonthlyInterestAccounts
 * 
 * 
 ...
 *   java com.bms.view.MonthlyInterestDemo
 *   
 *   Shows:
 ...
 *
 * Fund Transfer Demo:
 *   java com.bms.view.FundTransferDemo
 *   
 *   Shows:
 ...
 *     └── WorkflowCoordinationDocumentation.java (this file)
 * 
 */
public class WorkflowCoordinationDocumentation {
