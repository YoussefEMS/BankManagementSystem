...
public class InterestCalculatorPeerImpl implements IInterestCalculatorPeer {
    private static final Logger logger = Logger.getLogger(InterestCalculatorPeerImpl.class.getName());
