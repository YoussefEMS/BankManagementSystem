...
/**
 * PayPalPaymentClient - Concrete Adapter for PayPal Payment Gateway
 * 
 ...
 */
public class PayPalPaymentClient implements PaymentGateway {

    private static final String GATEWAY_NAME = "PayPal";
    private final String clientId;
    private final String clientSecret;

    public PayPalPaymentClient(String clientId, String clientSecret) {
