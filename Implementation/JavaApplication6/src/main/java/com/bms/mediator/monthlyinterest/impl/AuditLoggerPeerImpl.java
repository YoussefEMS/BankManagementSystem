...
public class AuditLoggerPeerImpl implements IAuditLoggerPeer {
    private static final Logger logger = Logger.getLogger(AuditLoggerPeerImpl.class.getName());
    private static final DateTimeFormatter TIMESTAMP_FORMAT = DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss");

    private StringBuilder auditLog;

    public AuditLoggerPeerImpl() {
