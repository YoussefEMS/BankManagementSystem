...
public class BalanceValidatorImpl implements IBalanceValidatorPeer {
    private static final Logger logger = Logger.getLogger(BalanceValidatorImpl.class.getName());
