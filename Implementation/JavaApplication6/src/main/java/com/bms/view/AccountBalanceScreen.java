...
public class AccountBalanceScreen {
    ...
    private AccountInfoSnapshot currentAccountInfoView;
    ...
    private void handleViewAccount() {
        ...
        try {
            ...
            AccountInfoSnapshot accountDetails = balanceController.getAccountDetails(accountNo);
     ...
     */
    private void displayAccount(AccountInfoSnapshot accountInfoView) {
