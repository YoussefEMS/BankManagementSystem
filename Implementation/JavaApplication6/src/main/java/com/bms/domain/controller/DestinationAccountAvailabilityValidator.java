...
public class DestinationAccountAvailabilityValidator implements DestinationAccountValidator {
    private static final Logger logger = Logger.getLogger(DestinationAccountAvailabilityValidator.class.getName());
    
    private final Map<String, DestinationAccountInfo> accounts;

    public DestinationAccountAvailabilityValidator() {
