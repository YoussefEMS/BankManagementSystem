...
import com.bms.domain.entity.PaymentStatus;
import java.math.BigDecimal;

/**
 * SquarePaymentClient - Concrete Adapter for Square Payment Gateway
 * 
 ...
 */
public class SquarePaymentClient implements PaymentGateway {

    private static final String GATEWAY_NAME = "Square";
    private final String accessToken;
    private final String locationId;

    public SquarePaymentClient(String accessToken, String locationId) {
