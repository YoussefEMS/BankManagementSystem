...
public class DatabaseTransferTransactionRecorder implements TransferTransactionRecorder {
    private static final Logger logger = Logger.getLogger(DatabaseTransferTransactionRecorder.class.getName());
    ...
    public DatabaseTransferTransactionRecorder() {
