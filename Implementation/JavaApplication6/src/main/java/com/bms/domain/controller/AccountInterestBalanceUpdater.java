...
public class AccountInterestBalanceUpdater implements InterestBalanceUpdater {
    private static final Logger logger = Logger.getLogger(AccountInterestBalanceUpdater.class.getName());
    ...
    public AccountInterestBalanceUpdater() {
