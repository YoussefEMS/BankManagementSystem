...
public class ActiveTransferAccountStatusChecker implements TransferAccountStatusChecker {
    private static final Logger logger = Logger.getLogger(ActiveTransferAccountStatusChecker.class.getName());
    
    private final Map<String, AccountStatus> accountStatuses;

    public ActiveTransferAccountStatusChecker() {
