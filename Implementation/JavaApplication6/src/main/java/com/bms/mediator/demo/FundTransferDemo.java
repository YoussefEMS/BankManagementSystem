...
import com.bms.mediator.fundtransfer.impl.*;
...
public class FundTransferDemo {
    ...
    public static void main(String[] args) {
        ...
        SourceAccountValidatorImpl sourceValidator = new SourceAccountValidatorImpl();
        System.out.println("✓ Source Account Validator initialized");
        
        DestinationAccountValidatorImpl destValidator = new DestinationAccountValidatorImpl();
        System.out.println("✓ Destination Account Validator initialized");
        
        AccountStatusHandlerImpl statusHandler = new AccountStatusHandlerImpl();
        System.out.println("✓ Account Status Handler initialized");
        
        OverdraftHandlerImpl overdraftHandler = new OverdraftHandlerImpl();
        System.out.println("✓ Overdraft Handler initialized");
        
        TransactionRecorderImpl transactionRecorder = new TransactionRecorderImpl();
        System.out.println("✓ Transaction Recorder initialized");
        
        BalanceValidatorImpl balanceValidator = new BalanceValidatorImpl();
        ...
        IFundTransferMediator mediator = new FundTransferMediatorImpl(
                sourceValidator,
                destValidator,
                statusHandler,
                overdraftHandler,
