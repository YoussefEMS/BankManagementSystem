...
public class AccountPeerImpl implements IAccountPeer {
    private static final Logger logger = Logger.getLogger(AccountPeerImpl.class.getName());
    
    // Mock database of accounts for demo purposes
    private final Map<String, AccountData> accounts;

    public AccountPeerImpl() {
